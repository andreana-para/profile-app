...
import useFetchedProfiles from '../hooks/fetchedProfileHook';


const FetchedProfiles = () => {

    const {handleChange, handleSearch, handleClick, title, search, titles, fetchedProfiles} = useFetchedProfiles();
